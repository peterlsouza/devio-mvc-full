...
namespace Pet.App.Controllers
{
    ...
    public class FornecedoresController : BaseController
    {
        ...
        {
            //vamos retornar um IEnumerable de FornecedorViewModel   -await retorna uma lista de fornecedores e será convertida em FOrnecedorViewModels
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            //acima verificamos se existe mesmo esse cara, depois deletamos..
        ...
        {
            //vamos obter os Fornecedores e endereco e transformar em uma FornecedorViewModel
